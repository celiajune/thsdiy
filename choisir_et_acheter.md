# Choisir et acheter de l'estradiol injectable
## Coût
Cette question peut être la plus importante pour les plus précarisé•e•s d'entre-nous.

Une fiole de 10 mL d'estradiol coûte de 40 à 60€ et dure 12 à 18 mois. Il faut ajouter 20-30€ pour le matériel d'injection (seringues et tampons désinfectants) pour cette même durée.

## Types d'estradiol injectable
### Les esters
L'estradiol injectable est disponible sous plusieurs formes, appelées esters. 

L’estérification de l'estradiol (**très** grossièrement résumée 🫠) consiste en la liaison d'une chaîne carbonée plus ou moins longue avec la molécule initiale (l'estradiol), ce qui a pour effet d'en modifier les propriétés pharmacocinétiques. Une fois injectée dans le corps, l'organisme va mettre plus ou moins longtemps à décomposer la chaîne carbonée, ce qui va permettre le relâchement progressif de l'estradiol dans le corps. C'est donc principalement **le type d'ester qui définit** la pharmacocinétique de la solution injectable : sa "vitesse d'absorption par l'organisme", et donc **la fréquence des injections**. 
...
Il existe plusieurs esters d'estradiol disponibles sur le marché. Leur différence principale réside dans la fréquence d'injection nécessaires pour garder des taux stables. Tu verras surtout ces noms : valérate, énanthate et undécylate d'estradiol.
...
- **L'énanthate d'estradiol est la molécule à privilégier dans tous les cas.** Elle permet des taus stables avec une injection hebdomadaire. Sa pharmacocinétique est bien connue et assez prévisible.
